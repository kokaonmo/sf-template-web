<template>
  <div class="border-bottom white-bg dashboard-header">
    ...
    <e-panel title="가동률" style="height: 300px;">
      <e-operation-chart class="layout-horizontal" width="1600" height="250"></e-operation-chart>
    </e-panel>
    <e-panel title="관리도 분석" style="height: 500px;">
      <e-operation-manage-chart style="display: inline-block;" class="layout-horizontal" width="1200" height="460"></e-operation-manage-chart>
...
<script>
  ...
  import eOperationChart from './OperationChart'
  import eOperationManageChart from './OperationManageChart'
