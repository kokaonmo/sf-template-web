<template>
  <div class="border-bottom white-bg dashboard-header">
    ...
    <e-panel title="성능가동률" style="height: 300px;">
      <e-performance-chart class="layout-horizontal" width="1600" height="250"></e-performance-chart>
    </e-panel>
    <e-panel title="관리도 분석" style="height: 500px;">
      <e-performance-manage-chart style="display: inline-block;" class="layout-horizontal" width="1200" height="460"></e-performance-manage-chart>
...
<script>
  ...
  import ePerformanceChart from './PerformanceChart'
  import ePerformanceManageChart from './PerformanceManageChart'
