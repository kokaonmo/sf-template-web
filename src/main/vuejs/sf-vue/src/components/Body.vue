<template>
  <div class="border-bottom white-bg dashboard-header">
    ...
    <e-panel title="정지현황" style="height: 300px">
      <e-pie-chart v-for="pie in pies" :key="pie.name" class="layout-horizontal" :title="pie.title" :dataProvider="pie.dataProvider" legendHorizontalAlign="right" legendVerticalAlign="top" legendLayout="vertical" width="350" height="250"></e-pie-chart>
    </e-panel>
